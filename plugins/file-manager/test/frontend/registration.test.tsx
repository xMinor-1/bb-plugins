...
describe("nav panel registration (§10)", () => {
  ...
  // launchers, v0.6 the two file openers, v0.7 the composer customization
  // (§8.8); everything else is still off. Its contents are covered by
  // test/frontend/mentions.test.tsx.
  it("registers no frontend slots beyond the panel, the settings section, the launchers, the openers and the composer row", () => {
