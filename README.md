...
| [pdf-viewer](plugins/pdf-viewer) | Просмотр PDF внутри bb: любой файл `.pdf` открывается вкладкой панели вместо скачивания — со страницами, зумом, поиском и печатью, — плюс пункт «PDF» в сайдбаре с обходом папок хоста и списком недавно открытых. Файлы до 25 МБ идут через штатный превью-транспорт bb (работает и для других хостов, и при удалённом доступе), крупнее — потоком с диска сервера с поддержкой докачки по диапазонам | Не выпущен, ставится из репозитория |
